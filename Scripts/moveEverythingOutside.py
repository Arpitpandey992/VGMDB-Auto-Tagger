...
import shutil
import argparse
folderPath = "/run/media/arpit/DATA/Downloads/Torrents/Key Sounds Label/[KSLC]/[2008.05.10] KSL LIVE WORLD 2008 Pamphlet and Memorial Disc [KSLC-0001~2] [CD-FLAC]"
