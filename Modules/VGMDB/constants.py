APICALLRETRIES = 5
USE_LOCAL_SERVER = False  # This is not working lately, so better to just up the service using "docker-compose up" after cloning "https://github.com/Arpitpandey992/vgmdb"
